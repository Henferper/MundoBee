//IP do Esp na rede está na porta com o nome Espressif
...
// Caracteres personalizados para o LCD (abelha)
byte abelhaParte1[8] = {
  B00000, B01010, B11111, B11111, B01110, B00100, B01010, B00000
};
byte abelhaParte2[8] = {
  B00000, B00100, B11111, B11111, B01110, B00100, B01010, B00000
};
byte abelhaParte3[8] = {
  B00000, B01010, B11111, B11111, B01110, B00100, B01010, B00000
};
...
void loop() {
  ...
  lcd.setCursor(17, 0);
  lcd.write(byte(0));  // Primeira parte da abelha
  lcd.setCursor(18, 0);
  lcd.write(byte(1));  // Segunda parte da abelha
  lcd.setCursor(19, 0);
  lcd.write(byte(2));  // Terceira parte da abelha
  ...
  lcd.setCursor(10, 2);
  lcd.print("IN:");
  lcd.print(totalInCount);
  lcd.setCursor(10, 3);
  lcd.print("OUT:");
  lcd.print(totalOutCount);
  ...
  if (temperature >= 40) {
    ...
    seguranca = 1;
    Serial.println("Temperatura interna alta! Sistema desligado por segurança.");
  } else if (outsideTemp <= 32 && seguranca == 0) {
